/* Generated by GOB (v2.0.8) on Sat Dec  4 16:32:10 2004
...
#line 40 "phatfansliderpix.gob"
	...
	{
	    self->filled = gdk_pixbuf_new_from_file("/usr/share/phat/slider_full.png", NULL);
	}
	...
	{
	    self->empty = gdk_pixbuf_new_from_file("/usr/share/phat/slider_empty.png", NULL);
	}
	...
	{
	    self->edge = gdk_pixbuf_new_from_file("/usr/share/phat/slider_edge.png", NULL);
	}
	g_free(tempname);
