/* Generated by GOB (v2.0.8) on Fri Oct 29 23:56:47 2004
...
#line 40 "drum.gob"
	...
	slider = phat_hfan_slider_new_with_range(1, 0.0, 1.0, .1);
	...
	while((name = va_arg(ap, char*)) != NULL)
	{
	    ...
	    slider = phat_hfan_slider_new_with_range(.5, 0.0, 1.0, .1);
	    gtk_box_pack_start(GTK_BOX(widget), slider, FALSE, FALSE, 0); 
	    gtk_widget_show(slider);
...
#line 102 "drum.gob"
	...
	if (lo_send(addr, data, "f", phat_fan_slider_get_value(PHAT_FAN_SLIDER (widget))) == -1) {
