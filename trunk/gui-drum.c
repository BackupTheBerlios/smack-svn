/* Generated by GOB (v2.0.8) on Sun Jan 23 22:53:06 2005
...
#line 125 "drum.gob"
	...
	{
	    /* call patch_loader to load the patch DODGY */
	    argv = g_new(gchar *, 4);
	    argv[0] = "/usr/bin/om_patch_loader";                /* program to call                 */
	    argv[1] = (gchar*) data; /* get filename */
	    //argv[1] = "/home/loki/Documents/svn/trunk/om/smack808/808cowbell.om";
	    argv[2] = "-u osc.udp://localhost:19383/ ";  /* FIXME */
	    argv[3] = NULL;                  /* end of argument list */
		...
		NULL,      /* where to put wget's stdout file descriptor                */
		NULL,      /* where to put wget's stderr file descriptor                */
		&error))
	    {
