/* Generated by GOB (v2.0.11) on Thu Sep 22 17:04:21 2005
...
#line 155 "drum.gob"
	...
	{
	    command = g_strconcat("om_patch_loader ", PKGDATADIR, "/", (gchar*) gtk_object_get_data(GTK_OBJECT(widget), "file_name"), NULL);
