/* Generated by GOB (v2.0.8) on Wed Mar  2 11:54:33 2005
...
#line 42 "drum.gob"
	...
	while((name = va_arg(ap, char*)) != NULL)
	{
	    ...
	    slider = phat_fan_slider_pix_new_with_range((lower+upper)/2, lower, upper, 0.1);
...
#line 127 "drum.gob"
	...
	command = g_strconcat("/", (gchar*) gtk_object_get_data(GTK_OBJECT(widget), "drum_name"), "/", (gchar*) gtk_object_get_data(GTK_OBJECT(widget), "node_name"), "/", (gchar*) gtk_object_get_data(GTK_OBJECT(widget), "param_name"), NULL);
	if (lo_send(addr, "/om/synth/set_port_value", "isf", 42, command,phat_fan_slider_get_value(PHAT_FAN_SLIDER (widget))) == -1) {
